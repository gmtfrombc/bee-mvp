...
| ------- | ------------------------------------------------------------ | -------- | ------ |
| T1      | Port scoring rules into `motivation_scoring_service.dart`    | 3h       | 🟡     |
| T2      | Generate `motivation_type`, `readiness_level`, `coach_style` | 2h       | 🟡     |
| T3      | Unit tests for all permutations                              | 2h       | 🟡     |
| T4      | Write edge-function `/sync-ai-tags.ts` stub                  | 3h       | 🟡     |
