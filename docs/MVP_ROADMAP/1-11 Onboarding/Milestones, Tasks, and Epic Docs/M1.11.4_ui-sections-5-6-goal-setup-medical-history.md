...
| ------- | ------------------------------------------------------- | -------- | ------ |
| T1      | Build `GoalSetupPage` with dynamic target field         | 4h       | 🟡     |
| T2      | Build `MedicalHistoryPage` with paginated checkbox grid | 4h       | 🟡     |
| T3      | Implement numeric & range validation                    | 3h       | 🟡     |
| T4      | Persist draft to `shared_preferences`                   | 2h       | 🟡     |
