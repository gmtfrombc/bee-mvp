...
class TestMomentumScoreCalculator:
    ...
    def create_engagement_event(
        ...
        result = self.supabase.table("engagement_events").insert(event_data).execute()
        return result.data[0]

    def create_historical_score(
        ...
        result = (
            self.supabase.table("daily_engagement_scores").insert(score_data).execute()
        )
        return result.data[0]
    ...
    def test_single_user_score_calculation(self):
        ...
        saved_score = (
            self.supabase.table("daily_engagement_scores")
            .select("*")
            .eq("user_id", self.test_user_id)
            .eq("score_date", self.test_date)
            .execute()
        )
    ...
    def test_zone_classification_rising(self):
        ...
        for _ in range(5):
            self.create_engagement_event("lesson_completion")  # 5 * 15 = 75 points
    ...
    def test_daily_score_cap(self):
        ...
        for _ in range(10):
            self.create_engagement_event("streak_milestone")  # 10 * 25 = 250 points
    ...
    def test_calculate_all_users_batch_processing(self):
        ...
        response = self.call_edge_function(
            {"calculate_all_users": True, "target_date": self.test_date}
        )
    ...
    def test_batch_processing_handles_user_errors(self):
        ...
        self.supabase.table("engagement_events").insert(invalid_event_data).execute()
    ...
    def test_invalid_user_id(self):
        ...
        response = self.call_edge_function(
            {"user_id": "invalid-uuid", "target_date": self.test_date}
        )
    ...
    def test_invalid_date_format(self):
        ...
        response = self.call_edge_function(
            {"user_id": self.test_user_id, "target_date": "invalid-date"}
        )
    ...
    def test_future_date_handling(self):
        ...
        response = self.call_edge_function(
            {"user_id": self.test_user_id, "target_date": future_date}
        )
    ...
    def test_historical_data_performance(self):
        ...
        for i in range(30):
            score_date = (datetime.now() - timedelta(days=i + 1)).date().isoformat()
    ...
    def test_unauthorized_access(self):
        ...
        response = requests.post(
            EDGE_FUNCTION_URL,
            json={"user_id": self.test_user_id, "target_date": self.test_date},
        )
