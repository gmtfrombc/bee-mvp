...
class TestMomentumCalculationUnitTests:
    ...
    def create_mock_event(
        self, event_type: str, event_date: str = None, points: int = None
    ) -> Dict:
        ...
        return {
            ...
            or MOMENTUM_CONFIG["EVENT_WEIGHTS"].get(event_type, 5),
        }

    def create_mock_historical_score(
        self, score_date: str, final_score: float, momentum_state: str
    ) -> Dict:
    ...
    def call_edge_function(
        ...
        try:
            ...
            mock_response.json.return_value = {"error": f"Connection error: {str(e)}"}
    ...
    def test_raw_score_calculation_with_limits(self):
        ...
        expected_max_score = (
            MOMENTUM_CONFIG["EVENT_WEIGHTS"]["lesson_completion"]
    ...
    def test_exponential_decay_calculation(self):
        ...
        expected_decay_factor = math.exp(-MOMENTUM_CONFIG["DECAY_FACTOR"] * days_ago)
        expected_decayed_score = base_score * expected_decay_factor

        # Verify decay calculation
        calculated_decay_factor = math.exp(-MOMENTUM_CONFIG["DECAY_FACTOR"] * days_ago)
    ...
    def test_exponential_decay_half_life_accuracy(self):
        ...
        decay_factor = math.exp(-MOMENTUM_CONFIG["DECAY_FACTOR"] * half_life_days)
    ...
    def test_zone_classification_thresholds(self):
        ...
        for score, expected_state in test_cases:
            ...
            ), f"Score {score} should be {expected_state}, got {calculated_state}"
    ...
    def test_hysteresis_buffer_logic(self):
        ...
        assert (
            calculated_state == "Rising"
        ), "Hysteresis should prevent immediate state change"
    ...
    def test_score_normalization_logic(self):
        ...
        for raw_score in test_raw_scores:
            ...
            normalized_score = min(raw_score, MOMENTUM_CONFIG["MAX_DAILY_SCORE"])
    ...
    def test_single_user_calculation_endpoint(self):
        ...
        payload = {"user_id": self.test_user_id, "target_date": self.test_date}
    ...
    def test_invalid_action_handling(self):
        ...
        payload = {"action": "invalid_action", "user_id": self.test_user_id}
    ...
    def test_invalid_user_id_formats(self):
        ...
        for invalid_id in invalid_user_ids:
            payload = {"user_id": invalid_id, "target_date": self.test_date}
    ...
    def test_invalid_date_formats(self):
        ...
        for invalid_date in invalid_dates:
            payload = {"user_id": self.test_user_id, "target_date": invalid_date}
    ...
    def test_calculation_with_extreme_values(self):
        ...
        capped_score = min(extreme_raw_score, MOMENTUM_CONFIG["MAX_DAILY_SCORE"])
    ...
    def test_calculation_with_old_historical_data(self):
        ...
        decay_factor = math.exp(-MOMENTUM_CONFIG["DECAY_FACTOR"] * very_old_days)
        decayed_score = base_score * decay_factor
    ...
    def test_calculation_performance_single_user(self):
        ...
        self.call_edge_function(payload)
        end_time = time.time()
    ...
    def test_algorithm_mathematical_properties(self):
        ...
        score_combined = sum(event["points_awarded"] for event in events_combined)
    ...
    def test_all_momentum_states_coverage(self):
        ...
        test_scores = [(80, "Rising"), (60, "Steady"), (30, "NeedsCare")]
...
def run_coverage_analysis():
    ...
    categories = {
        "Core Calculation": [
            ...
            if "calculation" in m or "score" in m or "decay" in m
        ],
        "API Endpoints": [m for m in test_methods if "endpoint" in m or "api" in m],
        "Error Handling": [
            m for m in test_methods if "error" in m or "invalid" in m or "missing" in m
        ],
        "Performance": [m for m in test_methods if "performance" in m or "memory" in m],
        "Algorithm Accuracy": [
            m
            for m in test_methods
            if "accuracy" in m or "consistency" in m or "mathematical" in m
        ],
        "Integration": [
            m
            for m in test_methods
            if "integration" in m or "end_to_end" in m or "system" in m
        ],
