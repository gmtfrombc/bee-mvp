...
void main() {
  group('CoachIntervention Model Tests', () {
    ...
    group('JSON Deserialization', () {
      ...
      test('should handle invalid enum values with fallbacks', () {
        final json = {
          'id': 'test-123',
          'patient_name': 'Test Patient',
          'type': 'invalid_type',
      ...
      test('should handle empty/null JSON gracefully', () {
        ...
        expect(deserialized.patientName, equals('Unknown Patient'));
        expect(deserialized.type, equals(InterventionType.checkIn));
        expect(deserialized.priority, equals(InterventionPriority.medium));
        expect(deserialized.status, equals(InterventionStatus.pending));
      });
    ...
    group('Equality and Hashing', () {
      test('should be equal when all properties match', () {
        ...
        final intervention1 = CoachIntervention(
          id: 'test-123',
        ...
        final intervention2 = CoachIntervention(
          id: 'test-123',
          patientName: 'Jane Doe',
          type: InterventionType.checkIn,
          priority: InterventionPriority.medium,
        ...
        expect(intervention1, equals(intervention2));
        expect(intervention1.hashCode, equals(intervention2.hashCode));
      });
      ...
      test('should not be equal when properties differ', () {
        ...
        expect(intervention1, isNot(equals(intervention2)));
        expect(intervention1.hashCode, isNot(equals(intervention2.hashCode)));
      });

      test('should have consistent toString representation', () {
        final intervention = CoachIntervention(
          id: 'test-123',
          patientName: 'Jane Doe',
          type: InterventionType.checkIn,
          priority: InterventionPriority.medium,
        ...
        final stringRep = intervention.toString();
        expect(stringRep, contains('test-123'));
        expect(stringRep, contains('Jane Doe'));
        expect(stringRep, contains('checkIn'));
    ...
    group('Enum Parsing Edge Cases', () {
      test('should handle various intervention type formats', () {
        final testCases = {
          'check_in': InterventionType.checkIn,
          'checkin': InterventionType.checkIn,
          'check-in': InterventionType.checkIn,
          'momentum_support': InterventionType.momentumSupport,
          'momentumsupport': InterventionType.momentumSupport,
          'momentum-support': InterventionType.momentumSupport,
          'medication_reminder': InterventionType.medicationReminder,
          'wellness_check': InterventionType.wellnessCheck,
          'crisis_intervention': InterventionType.crisisIntervention,
          'follow_up': InterventionType.followUp,
          'invalid_type': InterventionType.checkIn, // fallback
        };
        ...
        testCases.forEach((input, expected) {
          ...
          final intervention = CoachIntervention.fromJson(json);
          expect(
            intervention.type,
            equals(expected),
      ...
      test('should handle various priority formats', () {
        final testCases = {
          'low': InterventionPriority.low,
          'medium': InterventionPriority.medium,
          'high': InterventionPriority.high,
          'urgent': InterventionPriority.urgent,
          'invalid_priority': InterventionPriority.medium, // fallback
        };
      ...
      test('should handle various status formats', () {
        final testCases = {
          ...
          'in-progress': InterventionStatus.inProgress,
          'completed': InterventionStatus.completed,
          'cancelled': InterventionStatus.cancelled,
          'canceled': InterventionStatus.cancelled,
          'no_response': InterventionStatus.noResponse,
          'noresponse': InterventionStatus.noResponse,
          'no-response': InterventionStatus.noResponse,
          'invalid_status': InterventionStatus.pending, // fallback
        };
