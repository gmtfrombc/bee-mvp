...
/// Domain service responsible for generating personalized notification content
/// based on momentum states and user context.
///
/// Consolidates functionality from notification_content_service.dart into
...
class NotificationContentService {
  ...
  /// Get quotes specific to momentum state
